    ...
    public ArrayList<String> addReplique(String nom){
        ...
        switch (nom) {
            ...
            case "moine":
                ...
                break;
            case "spectre":
            	lines.add("Pour avancer dans le jeu, faites 5000 pas ou regardez une pub sur le panneau à côté !!");
                lines.add("AAAAH JE NE SENS PLUS MES JAMBES !!!!! Oh. Je suis un fantôme, c'est vrai.");
                break;
            case "vieux":
            ...
            case "épouvantail":
                ...
                break;
            case "panneau":
                lines.add("#AD Mais si c'est possible avec la carte Kiwi !\n" + //
                        "L'enfant de moins 16 ans\n" + //
